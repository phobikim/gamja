...
import com.example.gamja.dto.RecipeDto.IngredientDto;
import com.example.gamja.entity.Item;
import com.example.gamja.entity.ItemRecipe;
import com.example.gamja.repository.ItemRecipeRepository;
import com.example.gamja.repository.ItemRepository;
...
public class AdminController {
    ...
    private void addIngredient(List<IngredientDto> list, Map<Long, Item> itemMap, Long id, Integer qty) {
        if (id != null && qty != null) {
