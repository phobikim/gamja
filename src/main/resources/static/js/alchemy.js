...
function getOptionLabel(type) {
    switch (type) {
        case "HP": return "체력";
        case "POWER": return "공격력";
        case "CRITICAL_RATE": return "치명타 확률";
        case "CRITICAL_DAMAGE": return "치명타 피해";
        case "EXP_GAIN": return "경험치 증가";
