...
public interface UserEquipmentRepository extends JpaRepository<UserEquipment, Long> {
    ...
    boolean existsByUserIdAndItemIdAndType(Long userId, Long itemId, EquipmentType type);
    long countByUserIdAndSlotAndType(Long userId, EquipmentSlot slot, EquipmentType type);
